...
class VideoGames:
    def __init__(self):
        ...
        self.index = 0
        # https://store.steampowered.com/api/appdetails?appids=435150 DIVINITY ORIGINAL SIN 2
        # https://store.steampowered.com/api/appdetails?appids=1687950 PERSONA 5 ROYAL
        # https://store.steampowered.com/api/appdetails?appids=1222690 DRAGON AGE INQUISITION
        ...
        self.steam_ids = ["435150","1687950","1222690"]
